...
async function main() {
    ...
    const models = [
        ...
        },
        {
            ...
            "contents": [
                { "@type": "Telemetry", "name": "status", "schema": "boolean" },
                { "@type": "Telemetry", "name": "energyConsumption", "schema": "double" }
            ]
        },
        ...
        // ----------------- DOWNSTREAM -----------------
        {
            ...
            "contents": [
                { "@type": "Telemetry", "name": "temperature", "schema": "double" },
                { "@type": "Telemetry", "name": "pressure", "schema": "double" },
                { "@type": "Telemetry", "name": "throughput", "schema": "double" },
                {
                    "@type": "Relationship",
                    "name": "Supplies",
        ...
        },
        {
            ...
            "contents": [
                { "@type": "Telemetry", "name": "fuelInventory", "schema": "double" },
                { "@type": "Telemetry", "name": "sales", "schema": "double" }
            ]
        },
